        ...
        <div className="relative p-6 md:p-8">
          <div className="flex items-start justify-between mb-6">
            <div>
              ...
              <h2 className="text-[22px] font-semibold text-white tracking-tight">Create a new video</h2>
              <p className="text-[13px] text-zinc-400 mt-1">Upload an image and describe the motion you want.</p>
            </div>
          ...
          <div className="mb-5">
            ...
            <textarea
              ...
              rows={3}
              placeholder="Describe the motion... Rift AI will refine it for you"
          ...
          <div className="flex items-center justify-between pt-4 border-t border-[#141821]">
            ...
            <div className="flex items-center gap-2">
              ...
              <button className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-gradient-to-b from-purple-500 to-purple-600 hover:from-purple-400 hover:to-purple-500 text-white text-[13px] font-semibold shadow-lg shadow-purple-500/30 transition-all">
