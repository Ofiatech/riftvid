...
import { Plus, RefreshCw, Loader2, Film, Search, Bell, Menu } from 'lucide-react';
...
export default function ProjectsPage() {
  ...
  const handleDelete = async (id: string) => {
    if (!confirm('Delete this project? All scenes and clips inside will be deleted too. This cannot be undone.')) {
      return;
    }
    try {
        ...
        <div className="px-4 sm:px-10 py-6 sm:py-8 max-w-[1400px]">
          ...
          <div className="mb-8">
            ...
            <p className="text-[14px] text-zinc-400">
              Multi-scene AI movie projects. Build narratives clip by clip, scene by scene.
            </p>
          </div>
          ...
          {loading ? (
            ...
            <div className="rounded-2xl border border-dashed border-[#1f2937] bg-white/[0.01] p-16 text-center">
              ...
              <p className="text-[13px] text-zinc-400 mb-6 max-w-md mx-auto">
                Projects let you organize scenes and clips into full narrative videos.
                Perfect for AI movies, episodes, and multi-scene content.
              </p>
              <button
                onClick={() => setModalOpen(true)}
